...
<head>
    <title>Katalog Produk Toko ...</title>
    <meta charset="utf-8">
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                <div class="flex-fill">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#katalog">Shop</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="container">
                <div class="row p-5">
                    <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                        <img class="img-fluid" src="<?= base_url('katalog/') ?>/assets/img/banner_img_01.jpg" alt="">
                    </div>
                    <div class="col-lg-6 mb-0 d-flex align-items-center">
                        <div class="text-align-left align-self-center">
                            <h1 class="h1 text-success"><b>TOKO Z</b></h1>
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body d-flex align-items-between justify-content-between flex-column">
                                <ul class="list-unstyled d-flex justify-content-between">
                                    <li class="text-muted text-right">Rp <?= $row['harga_produk'] ?></li>
                                </ul>
                                <a href="shop-single.html" class="h2 text-decoration-none text-dark"><?= $row['nama_produk'] ?></a>
                                <p class="card-text">
                                    <?= $row['deskripsi'] ?>
                                </p>
                                <a href="https://wa.me/6287774265630?&text=Halo%2C%20saya%20ingin%20membeli%20celana%20jean%20dari%20toko%20anda" target="_blank" class="btn btn-primary">Beli Sekarang</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
