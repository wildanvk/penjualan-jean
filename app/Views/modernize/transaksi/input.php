    ...
    <form action="/Transaksi/store" method="post">
        ...
        <div class="card-body p-4">
            <div class="mb-4 row align-items-center">
                <label for="tgl_transaksi" class="form-label fw-semibold col-sm-2 col-form-label">Tanggal
                    Transaksi</label>
                <div class="col-sm-6">
                    <input type="date" class="form-control" id="tgl_transaksi" placeholder="Masukkan tanggal transaksi"
            ...
            <div class="mb-4 row align-items-center">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="id_transaksi" placeholder="Masukkan ID Supplier"
            ...
            <div class="mb-4 row align-items-center">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="nama_customer" placeholder="Masukkan Nama Customer"
                        name="nama_customer" value="<?= old('nama_customer') ? old('nama_customer') : '' ?>">
                </div>
            </div>
            <div class="mb-4 row align-items-center">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="alamat" placeholder="Masukkan Alamat Pelanggan"
                        name="alamat" value="<?= old('alamat') ? old('alamat') : '' ?>">
                </div>
            </div>
            <div class="mb-4 row align-items-center">
                <label for="no_hp" class="form-label fw-semibold col-sm-2 col-form-label">No HP</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="no_hp" placeholder="Masukkan No HP Pelanggan"
                        name="no_hp" value="<?= old('no_hp') ? old('no_hp') : '' ?>">
                </div>
            </div>
            <div class="mb-4 row align-items-center">
            ...
            <div class="mb-4 row align-items-center">
                ...
                <div class="col-sm-6">
                    <input type="number" class="form-control" id="jumlah_barang" placeholder="Masukkan Jumlah Barang"
                        name="jumlah_barang" value="<?= old('jumlah_barang') ? old('jumlah_barang') : '' ?>">
                </div>
            </div>
            <div class="mb-4 row align-items-center">
                <label for="total_bayar" class="form-label fw-semibold col-sm-2 col-form-label">Total Harga</label>
                <div class="col-sm-6">
                    <input type="number" class="form-control" id="total_bayar" placeholder="Masukkan Nama Barang"
                        name="total_bayar" value="<?= old('total_bayar') ? old('total_bayar') : '' ?>">
                </div>
            </div>
            <div class="row">
