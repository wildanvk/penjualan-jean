...
<head>
    ...
    <link rel="shortcut icon" type="image/png"
        href="<?php echo base_url('modernize-bootstrap'); ?>/dist/images/logos/logo.png" />
    <!-- Core Css -->
    <link id="themeColors" rel="stylesheet"
        href="<?php echo base_url('modernize-bootstrap'); ?>/dist/css/<?= session()->get('mode') == 'light' ? 'style.min.css' : 'style-dark.min.css' ?>" />
</head>
...
<body>
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="index.html" class="text-nowrap logo-img text-center d-block mb-5 w-100">
                                    <h1 class="text-primary-emphasis fw-bold">Zayn</h1>
                                </a>
    ...
    Swal.fire({
        ...
        text: '<?= session()->getFlashdata('forbidden') ?>',
        icon: 'error',
