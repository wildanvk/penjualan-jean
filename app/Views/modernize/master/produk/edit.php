...
<div class="card bg-light-info shadow-none position-relative overflow-hidden">
    <div class="card-body px-4 py-3">
        <div class="row align-items-center">
            <div class="col-9">
                <h4 class="fw-semibold mb-8">Edit Data Produk</h4>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item" aria-current="page">Data Produk</li>
                        <li class="breadcrumb-item" aria-current="page">Menu Edit Data Produk</li>
                    </ol>
                </nav>
            </div>
            <div class="col-2">
...
<div class="card w-100 position-relative overflow-hidden">
    <div class="px-4 py-3 border-bottom d-flex justify-content-between align-items-center bg-info">
        <h5 class="card-title fw-semibold mb-0 lh-sm text-white">Edit Data Produk</h5>
    </div>
    <form action="/produk/update" method="post" enctype="multipart/form-data">
        ...
        <div class="card-body p-4">
            <div class="row">
                <div class="col-6">
                    <input type="hidden" name="old_gambar_produk" value="<?= $produk['gambar_produk']; ?>">
                    <div class="mb-4 row align-items-center">
                        <label for="id_produk" class="form-label fw-semibold col-sm-3 col-form-label">ID
                            Produk</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="id_produk" value="<?= $produk['id_produk'] ?>"
                                name="id_produk" readonly>
                            <div class="ps-2 pt-2 fs-3 text-info">ID Produk tidak bisa diedit</div>
                        </div>
                    </div>
                    <div class="mb-4 row align-items-center">
                    ...
                    <div class="mb-4 row align-items-center">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="jumlah_produk"
                                ...
                                value="<?= old('jumlah_produk') ? old('jumlah_produk') : $produk['jumlah_produk'] ?>">
                        </div>
                    </div>
                    <div class="mb-4 row align-items-center">
                        ...
                        <div class="col-sm-9">
                            <select class="form-select" name="status" id="status">
                                ...
                                <option value="Tidak Aktif"
                                    <?= $produk['status'] === "Tidak Aktif" ? "selected" : "" ?>>
                                    Tidak
                                    Aktif</option>
                            </select>
                        </div>
                ...
                <div class="col-6 d-flex justify-content-center align-items-center">
                    <img src="<?= base_url('img/') . $produk['gambar_produk'] ?>" alt="Gambar Placeholder"
                        id="image-preview" height="300px" class="rounded-3 border border-primary" />
                </div>
            </div>
    </form>
</div>
