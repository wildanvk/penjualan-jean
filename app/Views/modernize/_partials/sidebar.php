    ...
    <div>
        <div class="brand-logo d-flex align-items-center justify-content-center" id="logo">
            <a href="index.html" class="text-nowrap">
                ...
                <!-- <img src="<?php echo base_url('modernize-bootstrap'); ?>/dist/images/logos/penjualan.png"
                    class="dark-logo" width="120" alt="" />
                <img src="<?php echo base_url('modernize-bootstrap'); ?>/dist/images/logos/penjualan.png"
                    class="light-logo" width="120" alt="" /> -->
            </a>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar>
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/laporan/transaksi" aria-expanded="false">
                        <span>
