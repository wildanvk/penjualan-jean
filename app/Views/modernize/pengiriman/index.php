                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p class="fw-medium fs-4" style="text-align: left !important; line-height: 2em !important">Apakah Anda
                                                yakin ingin menghapus data Pengiriman <span class="badge bg-primary"><?= $row['id_pengiriman'] ?></span> dengan nama
                                                Pengiriman <span class="badge bg-primary"><?= $row['id_pengiriman'] ?></span>?
                                            </p>
                                        </div>
