    ...
    <form action="/pengiriman/store" method="post">
        ...
        <div class="card-body p-4">
            <div class="mb-4 row align-items-center">
                <label for="tgl_pengiriman" class="form-label fw-semibold col-sm-2 col-form-label">Tanggal
                    Pengiriman</label>
                <div class="col-sm-6">
                    <input type="date" class="form-control" id="tgl_pengiriman"
                        placeholder="Masukkan Tanggal Pengiriman" name="tgl_pengiriman" value="<?= date("Y-m-d") ?>">
                </div>
            </div>
            <div class="mb-4 row align-items-center">
                <label for="id_pengiriman" class="form-label fw-semibold col-sm-2 col-form-label">ID Pengiriman</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="id_pengiriman" placeholder="Masukkan ID Pengiriman"
                        name="id_pengiriman" value="<?= $id_pengiriman ?>" readonly>
                </div>
            </div>
            <div class="mb-4 row align-items-center">
